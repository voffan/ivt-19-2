...
## RoadMap:
### MVP
- Главное окно приложения со страницами соревнований, достижений, спортсменов, локаций(❌), видов спорта(❌) ✅
- Соединение с базой данных (локально или удалённо) ✅
- Возможность добавления записи соревнований, достижений, спортсменов, локаций(❌), видов спорта(❌) ✅
- Возможность поиска записи соревнований(✅), достижений, спортсменов(✅), локаций, видов спорта ❌
- Возможность удаления записи соревнований(✅), достижений, спортсменов(✅), локаций, видов спорта ❌
- Возможность редактирования записи соревнований, достижений, спортсменов, локаций, видов спорта ❌
